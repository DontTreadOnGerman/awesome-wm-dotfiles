...
mytextclock = wibox.widget.textclock(" %a %b %d, %I:%M %p %Z ")
...
screen.connect_signal("request::desktop_decoration", function(s)
    ...
    s.mywibox.widget = {
        ...
        { -- Right widgets
            ...
            volume_widget({widget_type='arc', icon_dir='/home/dtog/.config/awesome/awesome-wm-widgets/volume-widget/icons'}),
            brightness_widget({widget_type = 'arc', program = 'light'}),
            battery_widget(),
            ram_widget(),
            mytextclock,
            weather_widget({
